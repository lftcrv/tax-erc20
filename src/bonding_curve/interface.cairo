...
pub trait IBondingCurve<TContractState> {
    ...
    fn simulate_buy(self: @TContractState, token_amount: u256) -> (u256, u256);
    fn simulate_sell(self: @TContractState, token_amount: u256) -> (u256, u256);
...
#[starknet::interface]
pub trait IBondingCurveABI<TContractState> {
    // View functions
    fn name(self: @TContractState) -> ByteArray;
    fn creator(self: @TContractState) -> ContractAddress;
    fn symbol(self: @TContractState) -> ByteArray;
